...
export default function HeroSection() {
  ...
  return (
    <div className="relative h-[50vh] lg:h-[90vh]">
      ...
      <div className="absolute bottom-12  left-5 transform md:left-7 z-40">
        <div className="flex mr-2 items-center">
           <span className="text-white bg-red-500 px-2 py-1 text-md font-bold mr-2 uppercase">{currentVideo.media_type=='movie'?'Movie':'Series'}</span>
            <span className="text-red-100 md:text-2xl font-bold uppercase">  cinema noir originals</span>
          </div>      
        <h1 className="text-3xl font-bold text-white mb-4 md:text-6xl md:w-3/4 md:my-5 uppercase">
          {currentVideo.title || currentVideo.name}
        </h1>
        <p className="hidden md:block text-lg leading-8 md:text-xl md:w-1/2 text-red-100 mb-8">{currentVideo.overview}</p>
        <div className="flex justify-start">
          ...
          <Link
            ...
            className="bg-gray-800 text-white md:text-lg px-4 py-2 md:py-3 rounded-md flex items-center gap-2 ml-4"
          >
